...
ALTER TABLE "watchlists" DROP CONSTRAINT "watchlists_user_id_users_id_fk";
--> statement-breakpoint
...
ALTER TABLE "watchlists" ADD CONSTRAINT "watchlist_user_movie_unique" UNIQUE("user_id","movie_id");